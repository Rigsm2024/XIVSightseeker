...
- 実現したかったこと
  - 探検手帳攻略に必要な情報を詰め込みたい
    ...
    - 地図表示は必須、どこを目指すべきかまずはざっくり把握してもらえる
...
- 情報の優先度に従って表示の目立たせ具合を調整している
  - 地図を一番大きく表示している
    ...
    - 地図情報は覚えやすいので、その項目が終わったかやどの辺になるのかなど大事な情報をまとめて把握できると判断
...
- Google Cloud Runで頑張る
  ...
  - CDは楽そうと言う理由でGitHubへのプッシュをトリガにするクラウドビルドを採用した
...
- 起動が遅い問題
  ...
  - 結果的に起動時の表示は劇的に改善された
    ...
    - 4秒でも本来は耐え難い時間ではあるが、一旦据え置きとしている
