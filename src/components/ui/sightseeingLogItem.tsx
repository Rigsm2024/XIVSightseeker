...
const SightseeingLogItem = ({ glog, filters, updateFilters }: SightseeingItemProps) => {
    ...
    return (
        <div className={`${phaseClass} w-full relative box-border p-1 pr-2`}>
            <div className='sightseeing-log-container flex flex-col'>
                ...
                <div className='flex flex-row flex-1'>
                    ...
                    <div className='flex flex-col items-center justify-center basis-16 self-stretch'>
                        {emoteIcon}
